...
* `df %>% dplyr::show_query()` permet d'afficher la traduction du traitement R qui est effectivement soumise à la base de données pour générer la table `df` (utile pour se familiariser avec SQL ou comprendre pourquoi le résultat ne correspond pas à nos attentes)
