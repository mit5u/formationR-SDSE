...
Jeu d'essai : 
```{r echo = FALSE}
df <- as_tibble(data.frame(poids = c(1,1,1,1,3),
...
- [jocelyn.beziau@insee.fr](mailto:jocelyn.beziau@insee.fr)
- [celine.techer@dreets.gouv.fr](mailto:celine.techer@dreets.gouv.fr)
